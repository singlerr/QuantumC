...
int main()
{
    const char *test_url = "https://httpbin.org/post";
    // For real IBM: "https://auth.quantum-computing.ibm.com/api/users/loginWithToken"
    const char *mock_api_key_payload = "{\"apiToken\": \"YOUR_REAL_IBM_API_KEY_HERE\"}";

    printf("Sending Request...\n");

    char *response = send_post_request(test_url, mock_api_key_payload, NULL);
    if (response)
    {
