...
struct placeholder *ph_builder_append(struct placeholder *chain, enum placeholder_kind kind, const char *name);
struct placeholder *ph_builder_begin(enum placeholder_kind kind, const char *name);
