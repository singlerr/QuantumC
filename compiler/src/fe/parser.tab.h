...
#ifndef YY_C_PARSER_TAB_H_INCLUDED
# define YY_C_PARSER_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef C_DEBUG
# if defined YYDEBUG
#if YYDEBUG
...
# define C_TOKENTYPE
  ...
  typedef enum c_tokentype c_token_kind_t;
#endif

/* Value type.  */
#if ! defined C_STYPE && ! defined C_STYPE_IS_DECLARED
typedef  char *str C_STYPE;
...
int c_parse (struct ast_node** root);


#endif /* !YY_C_PARSER_TAB_H_INCLUDED  */
