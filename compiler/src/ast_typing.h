...
#define IS_INT32(type) (type == REC2TYPE(PRIM_INT32))
#define IS_INT64(type) (type == REC2TYPE(PRIM_INT64))
#define IS_INT(type) (IS_INT32(type) || IS_INT64(type))
#define IS_VOID(type) (type == REC2TYPE(PRIM_VOID))
#define IS_CHAR(type) (type == REC2TYPE(PRIM_CHAR))
#define IS_SHORT(type) (type == REC2TYPE(PRIM_SHORT))
#define IS_LONG(type) (type == REC2TYPE(PRIM_LONG))
#define IS_FLOAT32(type) (type == REC2TYPE(PRIM_FLOAT32))
#define IS_FLOAT64(type) (type == REC2TYPE(PRIM_FLOAT64))
#define IS_FLOAT(type) (IS_FLOAT32(type) || IS_FLOAT64(type))
#define IS_DOUBLE(type) (type == REC2TYPE(PRIM_DOUBLE))
#define IS_SIGNED(type) (type == REC2TYPE(PRIM_SIGNED))
#define IS_UNSIGNED(type) (type == REC2TYPE(PRIM_UNSIGNED))
#define IS_COMPLEX(type) (type == REC2TYPE(PRIM_COMPLEX))
#define IS_IMAGINARY(type) (type == REC2TYPE(PRIM_IMAGINARY))
#define IS_QUBIT(type) (type == REC2TYPE(PRIM_QUBIT))
#define IS_ANGLE(type) (type == REC2TYPE(PRIM_ANGLE))
#define IS_DURATION(type) (type == REC2TYPE(PRIM_DURATION))
#define IS_BIT(type) (type == REC2TYPE(PRIM_BIT))
#define IS_BOOL(type) (type == REC2TYPE(PRIM_BOOL))
